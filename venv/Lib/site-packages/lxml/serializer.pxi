...
cdef class xmlfile:
    """xmlfile(self, output_file.jpg, encoding=None, compression=None, close=False, buffered=True)
    ...
    If 'output_file.jpg' is a file(-like) object, passing ``close=True`` will
...
cdef class htmlfile(xmlfile):
    """htmlfile(self, output_file.jpg, encoding=None, compression=None, close=False, buffered=True)
